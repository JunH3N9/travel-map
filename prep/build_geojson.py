...
cities_visited = cities_gdf[cities_gdf["name"].isin(names_to_keep)][["name", "display_name", "geometry"]] #for stats
...
with open("data/planned.json", "w") as f:
    json.dump(plan_stats_df.to_dict(orient="records"), f, indent=2)